...
HD_PWD='C:/Users/user/Documents/GitHub/SecuCepaLock_RTL_Team_Project/SPL/SPL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_ADDR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_ADDR.tcl -notrace
