...
read_verilog -library xil_defaultlib {
  ...
  C:/Users/kimhk/Documents/GitHub/SecuCepaLock_RTL_Team_Project/SPL/SPL.srcs/sources_1/new/MAIN_CODE.v
}
...
synth_design -top SPI_MASTER2 -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef SPI_MASTER2.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file SPI_MASTER2_utilization_synth.rpt -pb SPI_MASTER2_utilization_synth.pb"
