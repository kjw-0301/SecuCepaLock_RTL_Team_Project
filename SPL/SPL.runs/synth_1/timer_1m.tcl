...
synth_design -top timer_1m -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef timer_1m.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file timer_1m_utilization_synth.rpt -pb timer_1m_utilization_synth.pb"
